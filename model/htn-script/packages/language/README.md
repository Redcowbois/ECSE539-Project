...
- [src/htn-script.langium](src/htn-script.langium) -  The grammar definition of your language
- [src/htn-script-module.ts](src/htn-script-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/htn-script-validator.ts](src/htn-script-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/htn-script.monarch.ts](src/syntaxes/htn-script.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/htn-script.tmLanguage.json](syntaxes/htn-script.tmLanguage.json) - Textmate based syntax highlighting instructions.
