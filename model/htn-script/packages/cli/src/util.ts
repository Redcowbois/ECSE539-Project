...
const workspaceRoot = url.fileURLToPath(new URL('../../../', import.meta.url));
...
export function extractDestinationAndName(name: string, destination: string | undefined): FilePathData {
    return {
